    ...
    public class IntegrationTest
    {
        private class StartupMock
        {
            ...
            private CompositionContainer CreateCompositionContainer()
            {
                ...
                // Setup mock objects
                var generatorStub = new StubINameGenerator
                {
                    GenerateRandomBookTitleAsync = () => Task.FromResult("The Red House")
                };
        ...
        [TestMethod]
        public async Task SomeDemoTest()
        {
